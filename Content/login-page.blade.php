    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 bg-gray-50 flex flex-col justify-center items-center p-8">
            <div class="w-full max-w-md">
                ...
                <p class="text-center text-gray-600 text-sm" href="register-page" >
                    Don't have an account? <a href="register-page" class="text-blue-500 hover:text-blue-700">Create your account</a>
                </p>
            </div>
        </div>
    </div>
