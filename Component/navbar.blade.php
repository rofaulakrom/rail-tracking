    ...
    <nav class="navbar-top relative text-white p-2">
        <div class="container mx-auto flex justify-between items-center h-full">
            <div class="flex space-x-2">
                <a href="#"><img src="assets/images/facebookwhite.png" alt="Facebook" class="social-icon"></a>
                <a href="#"><img src="assets/images/xwhite.png" alt="Twitter" class="social-icon"></a>
                <a href="#"><img src="assets/images/instagramwhite.png" alt="Instagram" class="social-icon instagram-icon"></a>
            </div>
        </div>
    </nav>
    ...
    <nav class="navbar-middle bg-white text-black py-4">
        <div class="container mx-auto flex justify-between items-center">
            <div class="flex items-center space-x-4">
                <img src="assets/images/kailogistikwarna.png" alt="KAI Logistik" class="px-4 h-24 w-52">
            </div>
            ...
            <div>
                <img src="assets/images/akhlakwhite.png" alt="akhlak" class="h-15 w-48">
            </div>
        </div>
    </nav>
